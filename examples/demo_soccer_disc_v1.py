...
if __name__ == "__main__":
    ...
    if train:
        ma_env = SoccerEnv(n_team_players=n_team_players, perimeter_side=6, render=False)
    ...
    # TESTING SECTION
    ma_env = SoccerEnv(n_team_players=n_team_players, perimeter_side=6, render=True)
    ma_env = TimeLimitMAEnv(ma_env, max_episode_steps=1000)
